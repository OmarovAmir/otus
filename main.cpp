...
struct std_11_simple_allocator {
    ...
    template <class U> std_11_simple_allocator  (const std_11_simple_allocator<U>&) noexcept {}
...
struct cpp_11_allocator {
    ...
    {
        std::cout << __PRETTY_FUNCTION__ <<  std::endl;
        return pool.get(); //dummy implementation
    }
...
int main() {
    ...
    std::vector<int, cpp_11_allocator<int>> v0(10);
