...
template <class OutputBuffer> inline OutputBuffer decode_into(std::string_view data)
{
...
inline std::string from_base64(std::string_view data) { return decode_into<std::string>(data); }
